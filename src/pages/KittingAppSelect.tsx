...
const KittingAppSelect = () => {
  ...
  useEffect(() => {
    setOpen(true);
    const stored = (localStorage.getItem("kittings.vehicle.id") || "").trim();
  ...
  const onConfirm = () => {
    ...
    if (!vid) return;
    localStorage.setItem("kittings.vehicle.id", vid);
    setSubmitting(true);
    navigate("/menu/kitting/list");
  };
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="max-h-56 overflow-auto space-y-1">
                      {vehicleDropdownLoading ? (
                        ...
                        <div className="text-xs text-muted-foreground px-1">No kittings</div>
                      ) : (
...
export default KittingAppSelect;
