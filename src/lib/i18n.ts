...
const translations: Translations = {
  en: {
    ...
    retrievingToken: "Logging in…",
    tokenReceived: "Successfully logged in.",
    ...
    kittingDrawingFileNameLabel: "File Name",
  ...
  de: {
    ...
    retrievingToken: "Anmeldung läuft…",
    tokenReceived: "Erfolgreich angemeldet.",
    ...
    kittingMainItemLabel: "Komp. für Montage",
    ...
    kittingDrawingFileNameLabel: "Dateiname",
  ...
  "es-MX": {
    ...
    retrievingToken: "Iniciando sesión…",
    tokenReceived: "Sesión iniciada correctamente.",
    ...
    kittingMainItemLabel: "Comp. para ensambl.",
    ...
    kittingDrawingFileNameLabel: "Archivo",
  ...
  "pt-BR": {
    ...
    retrievingToken: "Entrando…",
    tokenReceived: "Login realizado com sucesso.",
    tokenFailed: "Falha ao obter o token de acesso.",
    menu: "MENU",
    signOut: "Sair",
    signOutTitle: "Sair",
    ...
    kittingMainItemLabel: "Comp. para montagem",
    ...
    kittingDrawingFileNameLabel: "Arquivo",
    kittingPrintLabel: "Imprimir",
